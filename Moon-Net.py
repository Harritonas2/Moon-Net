...
def select_theme():
    ...
    print_theme("Space", "[1] Space")

    print_theme("Fire", "[2] Fire")

    print_theme("Mix", "[3] Mix (default)")

    print_theme("Mix", "")

    print_theme("Mix", "Enter the number corresponding to your choice:")
